...
public class OctoBoss : MonoBehaviour, IEnemy
{
    ...
    public int _attackCooldown = 5; //cooldown between each attacks
    ...
    private BossHealthBar _healthBar; //healthbar of octo
